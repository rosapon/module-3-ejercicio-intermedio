...
const [countries, setCountries] = useState(originalCountriesList);

const [filterCountry, setFilterCountry] = useState("");

const filterCountries = countries.filter((country) => country.name.common.toLowerCase().includes(filterCountry.toLowerCase()))
